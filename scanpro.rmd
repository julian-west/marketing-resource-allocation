...
- How does feature and display promotional activity of each beer brand affect total store sales of beer? 

This analysis will look at promotional activity from the perspective of the store manager. It is assumed that the manager has full control over feature and display promotions and that there are no specific contractural obilgations with the brand supplier to promote the brand. The output of the SCAN*PRO model will direct the manager as to which brands should be promoted more frequently.
